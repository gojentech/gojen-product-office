...
```mermaid
flowchart LR
  Done["SPR-000 GAIOS Foundation<br/>Completed"] --> Active["SPR-001 SubscriptionOS Discovery<br/>Active"]
  Active --> Backlog["products/subscription-os/backlog/SPR-001.md"]
  Done --> Archive["sprints/SPR-000-GAIOS-Foundation.md"]
  Done --> DEC["DEC-001 GAIOS Adoption"]
```
