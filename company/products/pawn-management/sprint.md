# Pawn Management — Sprint Operating Model

| Field | Value |
| --- | --- |
| Document ID | GOS-GPO-279 |
| Title | Pawn Management — Sprint Operating Model |
| Product / Scope | PAW |
| Version | 1.0.0 |
| Status | Approved |
...
[Home](../../../README.md) › [Company](../../README.md) › [Products](../README.md) › [Pawn Management](./README.md) › Sprint Operating Model
...
Define how sprints operate for Pawn Management under GAIOS.
